...
const GameSelectionScreen = ({ currentUser, logoff, setTime }) => {
  ...
  return (
    <div className="GameSelectSplash">
      ...
      <div className="Two">
        <Link to={{ pathname: '/pre-game', state: { timeInSec: 120, gameType: 1 } }} onClick={() => setTime(120, 1)}>
      ...
      <div className="Five">
        <Link to={{ pathname: '/pre-game', state: { timeInSec: 300, gameType: 2 } }} onClick={() => setTime(300, 2)}>
      ...
      <div className="Ten">
        <Link to={{ pathname: '/pre-game', state: { timeInSec: 600, gameType: 3 } }} onClick={() => setTime(600, 3)}>
